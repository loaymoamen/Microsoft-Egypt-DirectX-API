...
inline float Model::GetX()const{ return x; }
inline float Model::GetY()const{ return y; }
inline float Model::GetZ()const{ return z; }
...
inline float Model::GetScaleX()const{ return scalex; }
inline float Model::GetScaleY()const{ return scaley; }
inline float Model::GetScaleZ()const{ return scalez; }
...
inline float Model::GetRotateX()const{ return rotatex; }
inline float Model::GetRotateY()const{ return rotatey; }
inline float Model::GetRotateZ()const{ return rotatez; }
